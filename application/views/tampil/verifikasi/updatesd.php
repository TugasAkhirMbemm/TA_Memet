<div class="col-md-12">
    ...
    <form method="post" action="<?php echo base_url('verifikasi/verifikasi/proses_update_sd') ?>" class="form-horizontal">
        <div class="box-body">
...
// }
function back(param){
document.location='<?php echo base_url(); ?>verifikasi/verifikasi/pgsd/'+param;
}
</script>
