<div class="col-md-12">
    ...
    <div class="box-header with-border">
        <h3 class="box-title">Verifikasi Awal Data User SMP</h3>
    </div>

    <?php foreach ($pengumuman->result() as $p) { ?>
    <form method="post" action="<?php echo base_url('verifikasi/verifikasiawal/proses_update_smp') ?>" class="form-horizontal">
        <div class="box-body">
...
// }
function back(param){
document.location='<?php echo base_url(); ?>verifikasi/verifikasiawal/pgsmp/'+param;
}
</script>
