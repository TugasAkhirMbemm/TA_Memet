...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 15, 2019 at 07:47 AM
...
(1, 'met', '081235295632', 'met', 'met', 4, 2),
(2, 'memet', '081235235235', 'memet', 'memet', 5, 2),
(3, 'admintk', '025895', 'admintk', 'admintk', 1, 1),
(4, 'adminsd', '02369999', 'adminsd', 'adminsd', 2, 1),
(7, 'adminsmp', '081235295632', 'adminsmp', 'adminsmp', 3, 2),
(8, 'metty', '08978907779', 'mett', 'met', 6, 2);
...
INSERT INTO `gambar` (`id_gambar`, `nama_gambar`, `id_user`, `id_admin_gambar`) VALUES
(1, 'met', 5, 1);
...
(1, 'budi', 'noni', '1945-06-06', '1945-06-20', 'S1', 'SMA', 'Teknik', '', 'Inovasi Jaya', 'Rumah tangga', 'estelon 3', '', '9 jam', '', 1000000000, 0, 500000, 0, 'jember', 'jember', 'jember', '', 81081081, 81081082, 81081083, 0, 'sering', 'sering', 3, 1, 1, 1, 1),
(2, 'bapak tayo', 'tolelot', '1945-06-03', '1945-06-26', 'STM', 'S1', '', 'Ekonomi', 'wirausaha', 'Guru', '', 'pns', '8', '8', 5000000, 8000000, 2000000, 1000000, 'Jember', 'jember', 'madiun', 'jember', 812365478, 823216469, 0, 123457, 'Setiap bulan', 'Setiap Minggu', 8, 1, 1, 2, 1);
...
(1, 50, '170', 1, 'Baik', 'Tidak ada', 'Tidak ada', 'Imunisasi biasa', 'Alergi Laut', 'Terlalu tajam', 'Baik', 'Standart', 1, 3);
...
(2, 'sebastian xiulengge', 's1', '', 123456, 1, 3);
...
(2, 'Metty Anugrah H', 'Metty', 'East Blue', '1997-06-12', 20, 'ortu', 1, 5, 2, 1, 1, 3, '081235234568'),
(3, 'holaa memet', 'memet', 'jakarta', '1997-08-09', 19, 'Ortu', 1, 6, 1, 1, 1, 3, '0814563216'),
(8, 'hey tayo', 'tayo', 'madura', '1996-12-16', 21, 'Ortu', 2, 5, 1, 2, 1, 3, '654789');
...
(5, 'met', 'met@gmail.com', 'met', 3),
(6, 'memet', 'memet@gmail.com', 'memet', 2),
(7, 'heny', 'heny@onepiece.com', 'henn', 1),
(8, 'anugrah', 'anugrah@gmail.com', '123', 1);
...
--
ALTER TABLE `admin`
  MODIFY `id_admin` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `gambar`
  MODIFY `id_gambar` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `nilai_tes`
  MODIFY `id_nilai_tes` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `siswa`
  MODIFY `id_siswa` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `data_awal`
  ADD CONSTRAINT `data_awal_ibfk_1` FOREIGN KEY (`id_jenjang`) REFERENCES `jenjang` (`id_jenjang`);
